...
<HTML>
		...
		$(function(){
			...
			$.getJSON(url,function(data){
				$(data).each(function(index,element){
					...
					$("#selectCategory").append("<option value="+element.cid+">"+element.cname+"</option>")
				})
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProductServlet_addProduct" method="post" enctype="multipart/form-data">
			&nbsp;
