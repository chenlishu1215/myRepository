...
<script type="text/javascript">
	function showDetail(oid) {
		$.getJSON("${pageContext.request.contextPath}/adminOrderServlet_showDetail", 
			...
			<ul class="pagination" style="text-align: center; margin-top: 10px;">
				...
				<c:forEach begin="1" end="${pageBean.totalPage }" var="i">
					<c:if test="${pageBean.curPage==i }">
						<li class="active"><a
							href="${pageContext.request.contextPath }/adminOrderServlet?method=findOrderByPage&state=${param.state }&curPage=${i}">${i}</a></li>
					</c:if>
					<c:if test="${pageBean.curPage!=i}">
						<li><a
							href="${pageContext.request.contextPath }/adminOrderServlet?method=findOrderByPage&state=${param.state }&curPage=${i}">${i}</a></li>
				...
				<c:if test="${pageBean.curPage!=pageBean.totalPage }">
					<li><a
						href="${pageContext.request.contextPath }/adminOrderServlet?method=findOrderByPage&state=${param.state }&curPage=${pageBean.curPage+1 }"
