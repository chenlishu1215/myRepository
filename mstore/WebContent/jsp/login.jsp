...
<%
		...
		String checked="";
		//获取密码验证码或密码出错时的用户名信息
		String backwrite=(String)pageContext.getRequest().getAttribute("username");
		if(backwrite!=null){
...
<div class="row"> 
	...
	<div class="col-md-5">
				...
				<font>会员登录</font>USER LOGIN <span style="color:red;">${msg }</span>
...
<form class="form-horizontal" action="${pageContext.request.contextPath }/user_login" method="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" value="${username }" class="form-control" id="username" placeholder="请输入用户名" name="username">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="password" value="${password }" class="form-control" id="inputPassword3" placeholder="请输入密码" name="password">
    </div>
  </div>
   <div class="form-group">
        <label for="inputPassword3" class="col-sm-2 control-label">验证码</label>
    <div class="col-sm-3">
      <input type="text"  name="vcode" class="form-control" id="inputPassword3" placeholder="请输入验证码">
    </div>
    <div class="col-sm-3">
      <img src="${pageContext.request.contextPath}/validate_getValidate" onclick="fn1(this)"/>
    </div>
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="auto" value="1" onclick="changeR(this)"> 自动登录
        </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label>
          <input type="checkbox" <%=checked %>  name="rem" value="1" id="rem"> 记住用户名
        </label>
      </div>
    </div>
  </div>
